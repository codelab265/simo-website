<div class="">
    ...
    <section id="serv">
        <div class="serv_m">
            <div class="container">
                <div class="row serv_1 text-center">
                    <div class="col-md-12">
                        <h5 class="lspace text-light">SERVICES</h5>
                        <h1 class="text-white">Provide Exclusive Services</h1>
                        <hr style="width:100px; height:5px; margin-left:auto; margin-right:auto;" class="text-white">
                    </div>
                </div>
                <div class="row serv_2 mt-3 text-center">
                    <div class="col-md-4">
                        <div class="spec_1im  text-center ">
        ...
        <div class="container">
            ...
            <div class="row team_h_2 mt-3">
                <div class="col-md-3">
                    <div class="team_h_2i position-relative">
                        <div class="team_h_2i1">
                            <img class="w-100" src="img/6.jpg" alt="abc">
                        </div>
                ...
                <div class="col-md-3">
                    <div class="team_h_2i position-relative">
                        <div class="team_h_2i1">
                            <img class="w-100" src="img/7.jpg" alt="abc">
                        </div>
                        <div class="team_h_2i2 position-absolute">
                            <ul class="mb-0">
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-md-3">
                    <div class="team_h_2i position-relative">
                        <div class="team_h_2i1">
                            <img class="w-100" src="img/8.jpg" alt="abc">
                        </div>
                        <div class="team_h_2i2 position-absolute">
                            <ul class="mb-0">
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-md-3">
                    <div class="team_h_2i position-relative">
                        <div class="team_h_2i1">
                            <img class="w-100" src="img/9.jpg" alt="abc">
                        </div>
                        <div class="team_h_2i2 position-absolute">
                            <ul class="mb-0">
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
        ...
        <div class="container">
            ...
            <div class="row team_h_2 mt-3">
                <div class="col-md-3 p-0">
                    <div class="team_h_2m position-relative">
                        <div class="team_h_2m1">
                            <img src="img/10.jpg" class="w-100" alt="abc">
                        </div>
                        <div class="team_h_2m2 text-center position-absolute">
                            <h5><a href="#">Web Design</a></h5>
                            <h6 class="mb-0">Design, Photoshop</h6>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-0">
                    <div class="team_h_2m position-relative">
                        ...
                        <div class="team_h_2m2 text-center position-absolute">
                            <h5><a href="#">Digital Service</a></h5>
                            <h6 class="mb-0">Design, Photoshop</h6>
                        </div>
                    </div>
                </div>
